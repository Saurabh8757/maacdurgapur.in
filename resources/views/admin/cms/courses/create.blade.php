...
<div class="content-wrapper cms-page">
    ...
    <section class="content"><div class="container-fluid"><div class="card cms-card cms-form-card">
        <form data-cms-form data-endpoint="{{ url('v1/cpanel/admin/cms/courses') }}" data-method="POST" data-redirect="{{ route('admin::content.courses.index') }}" enctype="multipart/form-data" novalidate>
