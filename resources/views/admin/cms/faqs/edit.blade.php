...
<div class="content-wrapper cms-page">
    <section class="content-header"><div class="container-fluid"><h1>Edit FAQ</h1></div></section>
    <section class="content"><div class="container-fluid"><div class="card cms-card cms-form-card">
        <form data-cms-form data-endpoint="{{ url('v1/cpanel/admin/cms/faqs/'.$faq->id) }}" data-method="PUT" data-redirect="{{ route('admin::content.faqs.index') }}" novalidate>
