...
<div class="content-wrapper cms-page">
    <section class="content-header"><div class="container-fluid"><h1>Create Showcase Category</h1></div></section>
    <section class="content"><div class="container-fluid"><div class="card cms-card cms-form-card">
        <form method="POST" action="{{ route('admin::content.showcase-categories.store') }}">
            @csrf
