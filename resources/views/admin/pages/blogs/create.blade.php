                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="excerpt" class="form-control" id="excerpt" rows="3" placeholder="Brief summary">{{ old('excerpt') }}</textarea>
                                    @error('excerpt') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="form-group">
                                    <label for="content">Content</label>
                                    <textarea name="content" class="form-control tinymce-editor" id="content" rows="10">{{ old('content') }}</textarea>
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="canonical_url" class="form-control" id="canonical_url" value="{{ old('canonical_url') }}">
                                </div>
                                <div class="form-group">
                                    <label for="og_title">OG Title</label>
                                    <input type="text" name="og_title" class="form-control" id="og_title" value="{{ old('og_title') }}">
                                </div>
                                <div class="form-group">
                                    <label for="og_description">OG Description</label>
                                    <textarea name="og_description" class="form-control" id="og_description" rows="2">{{ old('og_description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="author" class="form-control" id="author" value="{{ old('author', 'Admin') }}">
                                </div>
                                <div class="form-group">
                                    <label for="reading_time">Reading Time</label>
                                    <input type="text" name="reading_time" class="form-control" id="reading_time" placeholder="e.g., 5 min read" value="{{ old('reading_time') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="featured_order" class="form-control" id="featured_order" value="{{ old('featured_order', 0) }}">
                                </div>
                            </div>
