                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <span class="card-title alert alert-danger"><i class="fa fa-exclamation"></i>&nbsp;
                                    only one will show in website. which one is active. &nbsp;
                                    ...
                                    @if(!empty($allContact))
                                        ...
                                        @foreach($allContact as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="btn btn-warning btn-sm btn-flat" data-act="ajax-modal" data-title="Edit Contact" data-append-id="AjaxModelContent"
                                                       data-action-url="{{route("admin::edit_contact",['id'=>$data['id']])}}">
