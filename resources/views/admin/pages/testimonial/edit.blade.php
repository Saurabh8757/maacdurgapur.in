<div class="card-body">
    <form id="validation2" action="{{route('admin::update_testimonial',$data['id'])}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="exampleInputEmail1">Preview Image</label>
                    <img src="{{asset($data['profile_photo'])}}" alt="No Picture Found" style="width: auto;height: 200px;object-fit: cover;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <span style="color:red;">*</span>
                    <input type="text" value="{{$data['occupation']}}" name="occupation" class="validate[required] form-control" placeholder="Enter ...">
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Message</label>
                    <span style="color:red;">*</span>
                    <textarea name="message" class="form-control" rows="6" cols="50" placeholder="Enter ...">{{$data['message']}}</textarea>
                </div>
