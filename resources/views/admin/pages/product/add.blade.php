<div class="card-body">
    <form id="validation2" action="{{route('admin::save_product')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <span style="color:red;">*</span>
                    <textarea name="desc" class="summernote" rows="6" cols="50" placeholder="Enter ..."></textarea>
                </div>
                @if ($errors->has('desc'))
