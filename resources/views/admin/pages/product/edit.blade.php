<div class="card-body">
    <form id="validation2" action="{{route('admin::update_product',$data['id'])}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Title</label>
                    <span style="color:red;">*</span>
                    <input type="text" name="name" value="{{$data['name']}}" class="validate[required] form-control" placeholder="Enter ...">
                </div>
                @if ($errors->has('name'))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <span style="color:red;">*</span>
                    <textarea name="desc" class="summernote" rows="6" cols="50" placeholder="Enter ...">{{$data['desc']}}</textarea>
                </div>
                @if ($errors->has('desc'))
                    <span class="alert alert-danger">{{ $errors->first('desc') }}</span>
                @endif
            </div>
        </div>
        <!-- input states -->
