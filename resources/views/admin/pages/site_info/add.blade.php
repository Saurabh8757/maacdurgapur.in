...
<div class="card card-primary">
    <form id="validation2" action="{{route('admin::information_save')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="card-body">
            ...
            @if(!empty($siteInfo) && $siteInfo['is_image'] == 'No')
                <div class="form-group">
                    ...
                    <input type="text" class="validate[required] form-control" name="value" id="exampleInputEmail1" @if(!empty($siteInfo) && $siteInfo['is_image'] == 'No') value="{{$siteInfo['value']}}" @endif placeholder="Enter Value">
                </div>
