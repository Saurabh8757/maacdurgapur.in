...
@section('title', 'Add AKSHA Major Program')

@section('content')
<div class="content-wrapper cms-page">
    <section class="content-header"><div class="container-fluid"><h1>Add Major Program</h1></div></section>
    <section class="content"><div class="container-fluid"><div class="card cms-card cms-form-card">
        <form data-cms-form data-endpoint="{{ route('admin::aksha.major_programs.store') }}" data-method="POST" data-redirect="{{ route('admin::content.aksha.major-programs.index') }}" novalidate>
            <div class="card-body">
            ...
            <div class="card-footer cms-form-actions"><a href="{{ route('admin::content.aksha.major-programs.index') }}" class="btn btn-outline-secondary">Cancel</a><button type="submit" class="btn btn-primary"><i class="fas fa-save mr-1"></i> Save Program</button></div>
        </form>
    </div></div></section>
</div>
@endsection
