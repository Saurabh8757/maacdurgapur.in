...
<section id="maac" class="institute-section maac-section">
  ...
  <div class="brand-section-content align-right">
    ...
    <a href="{{ route('maac') }}" class="btn-register btn-gradient-orange scroll-to-hero-form">
      Explore Now →
    </a>
  </div>
</section>
...
<section id="aksha" class="institute-section aksha-section">
  ...
  <div class="brand-section-content align-left">
    ...
    <a href="{{ route('aksha') }}" class="btn-register btn-gradient-blue scroll-to-hero-form">
      Explore Now →
    </a>
  </div>
</section>
...
<section id="spacefic" class="institute-section spacefic-section">
  ...
  <div class="brand-section-content align-right">
    ...
    <a href="{{ route('space_e_fic') }}" class="btn-register btn-gradient-cyan scroll-to-hero-form">
      Explore Now →
    </a>
  </div>
</section>
