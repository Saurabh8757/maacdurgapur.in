document.addEventListener('DOMContentLoaded', () => {
    ...
    var form = document.getElementById('sefEnquiryForm');
    if (form) {
        ...
        form.addEventListener('submit', function (e) {
            ...
            .then(data => {
                if (data.status === 0 && data.error) {
                    ...
                    gsap.to(form, { opacity: 0, y: -20, duration: 0.4, onComplete: function () {
                        ...
                        successDiv.innerHTML = '<div class="success-checkmark"><svg viewBox="0 0 100 100" width="80" height="80"><circle class="success-circle" cx="50" cy="50" r="45" fill="none" stroke="url(#sefGoldGrad)" stroke-width="3"/><path class="success-check" d="M30 52 L44 66 L70 36" fill="none" stroke="url(#sefGoldGrad)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><defs><linearGradient id="sefGoldGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#ffd700"/><stop offset="100%" style="stop-color:#ff6a00"/></linearGradient></defs></svg></div><h3>Thank You! 🎉</h3><p>Our counsellor will contact you shortly.</p>';
            ...
            .finally(() => {
                ...
                if (btnText)  btnText.textContent = 'RESERVE DEMO';
